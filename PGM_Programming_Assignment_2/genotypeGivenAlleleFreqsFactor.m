...
freqA1 = alleleFreqs(genotypesToAlleles(:,1));
freqA2 = alleleFreqs(genotypesToAlleles(:,2));
multiplier = (genotypesToAlleles(:,1) ~= genotypesToAlleles(:,2)) + 1;
genotypeFactor.val = (freqA1 .* freqA2 .* multiplier)';
